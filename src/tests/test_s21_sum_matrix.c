...
START_TEST(test_s21_sum_matrix_3_1) {
  matrix_t A, B, result;
...
START_TEST(test_s21_sum_matrix_3_2) {
  matrix_t A, B, result;
...
START_TEST(test_s21_sum_matrix_4_1) {
  matrix_t A, B, result;
  s21_create_matrix(1, 1, &A);
...
START_TEST(test_s21_sum_matrix_4_2) {
  matrix_t A, B, result;
  s21_create_matrix(1, 1, &A);
  s21_create_matrix(1, 1, &B);
  B.matrix[0][0] = 1.0;
...
START_TEST(test_s21_sum_matrix_4_3) {
  matrix_t A, B, result;
  s21_create_matrix(1, 1, &A);
  s21_create_matrix(1, 1, &B);
  A.matrix[0][0] = 1.0;
...
START_TEST(test_s21_sum_matrix_4_4) {
  matrix_t A, B, result;
  s21_create_matrix(1, 1, &A);
  s21_create_matrix(1, 1, &B);
  A.matrix[0][0] = 1.0;
...
START_TEST(test_s21_sum_matrix_5_1) {
  matrix_t A, B, result;
...
START_TEST(test_s21_sum_matrix_5_2) {
  matrix_t A, B, result;
  ...
  ck_assert_int_eq(result.rows, 3);
  ck_assert_int_eq(result.columns, 2);
  ck_assert_double_eq(result.matrix[0][0], 11.0);
  ck_assert_double_eq(result.matrix[0][1], 22.0);
  ck_assert_double_eq(result.matrix[1][0], 33.0);
  ck_assert_double_eq(result.matrix[1][1], 44.0);
  ck_assert_double_eq(result.matrix[2][0], 55.0);
  ck_assert_double_eq(result.matrix[2][1], 66.0);
  s21_remove_matrix(&A);
  s21_remove_matrix(&B);
  s21_remove_matrix(&result);
}
...
START_TEST(test_s21_sum_matrix_5_3) {
  matrix_t A, B, result;
  ...
  ck_assert_double_eq(result.matrix[2][2], 7.0);
  s21_remove_matrix(&A);
  s21_remove_matrix(&B);
  s21_remove_matrix(&result);
}
...
void test_s21_sum_matrix(SRunner *runner) {
  ...
  // МАТРИЦЫ РАЗНОГО РАЗМЕРА
  tests = add_test(tests, test_s21_sum_matrix_3_1);
  tests = add_test(tests, test_s21_sum_matrix_3_2);
  // МАТРИЦЫ РАЗМЕРА 1х1
  tests = add_test(tests, test_s21_sum_matrix_4_1);
  tests = add_test(tests, test_s21_sum_matrix_4_2);
  tests = add_test(tests, test_s21_sum_matrix_4_3);
  tests = add_test(tests, test_s21_sum_matrix_4_4);
  // МАТРИЦЫ БОЛЬШЕГО РАЗМЕРА
  tests = add_test(tests, test_s21_sum_matrix_5_1);
  tests = add_test(tests, test_s21_sum_matrix_5_2);
  tests = add_test(tests, test_s21_sum_matrix_5_3);
